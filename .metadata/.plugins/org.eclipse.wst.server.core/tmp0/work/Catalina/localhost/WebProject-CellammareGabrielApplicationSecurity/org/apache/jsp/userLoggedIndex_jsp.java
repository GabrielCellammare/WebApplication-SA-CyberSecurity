 ...
 * Generated at: 2024-09-11 14:10:33 UTC
...
return;
    ...
    try {
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("// Chiamata AJAX separata per caricare la lista delle proposte quando la pagina si carica La funzione $(document).ready(function()) in jQuery viene utilizzata per assicurarsi che il codice JavaScript all'interno della funzione venga eseguito solo dopo che il documento HTML è stato completamente caricato e il DOM è pronto per essere manipolato.\r\n");
      ...
      out.write("\t\r\n");
      out.write("\tvar inattivitaTimer; // Variabile globale\r\n");
      out.write("\r\n");
      out.write("\tfunction resetInattivitaTimer() {\r\n");
      out.write("\t    if (inattivitaTimer) {\r\n");
      out.write("\t        clearTimeout(inattivitaTimer); // Pulisce il timer precedente se esiste\r\n");
      out.write("\t    }\r\n");
      out.write("\r\n");
      ...
      out.write("\t                window.location.href = \"userNotLoggedIndex.jsp\";\r\n");
      out.write("\t            }\r\n");
      out.write("\t        });\r\n");
      out.write("\t    }, 900000); // Timeout di 15 minuti (uguale per la sessione)\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      out.write("    // Eventi che indicano attività dell'utente\r\n");
      out.write("    $(document).on('mousemove keypress click', function() {\r\n");
      out.write("        resetInattivitaTimer();\r\n");
      out.write("    });\r\n");
      out.write("\r\n");
      out.write("    // Imposta inizialmente il timer di inattività quando la pagina si carica\r\n");
      out.write("    resetInattivitaTimer();\r\n");
      out.write("\r\n");
      out.write("});\r\n");
      out.write("\r\n");
      ...
      out.write("\t$\r\n");
      out.write("\t\t\t.ajax({\r\n");
      out.write("\t\t\t\turl : 'UploadProposalServlet', // L'URL della servlet sul server a cui inviare la richiesta\r\n");
      out.write("\t\t\t\ttype : 'POST', // Il tipo di richiesta HTTP, in questo caso POST per inviare dati\r\n");
      out.write("\t\t\t\tdata : formData, //dati da inviare al server\r\n");
      out.write("\t\t\t\tprocessData : false, // Impedisce a jQuery di elaborare automaticamente i dati (utile per l'invio di dati binari come i file)\r\n");
      out.write("\t\t\t\tcontentType : false, // Impedisce a jQuery di impostare automaticamente il tipo di contenuto, necessario quando si inviano dati binari\r\n");
      out.write("\t\t\t\tsuccess : function(data,textStatus,xhr) {  // Callback che viene eseguito quando la richiesta ha successo\r\n");
      out.write("\t\t\t\t\t// Aggiorna il contenuto del banner con il risultato della risposta AJAX\r\n");
      out.write("\t\t\t\t\t  var newCsrfToken = xhr.getResponseHeader('X-CSRF-Token');\r\n");
      out.write("\t\t\t          if (newCsrfToken) {\r\n");
      out.write("\t\t\t                $('#uploadForm [name=\"csrfToken\"]').val(newCsrfToken);\r\n");
      out.write("\t\t\t            }\r\n");
      ...
      out.write("\t\t\t        if (xhr.status === 401) {  // Se ricevi 401, reindirizza l'utente alla pagina di login\r\n");
      out.write("\t\t\t            window.location.href = 'userNotLoggedIndex.jsp';\r\n");
      out.write("\t\t\t        }\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t}\r\n");
      ...
      out.write("        // Effettua una chiamata al server per invalidare la sessione ed eliminare cookie\r\n");
      out.write("        $.ajax({\r\n");
      out.write("            url: 'LogoutServlet',\r\n");
      out.write("            type: 'GET',\r\n");
      out.write("            success: function () {\r\n");
      ...
      out.write("\t\t\t<button id=\"closeBannerButton\" class=\"button\" onclick=\"closeBanner()\">Chiudi\r\n");
      out.write("\t\t\t\tproposta</button>\r\n");
      out.write("\t\t\t<a href=\"userNotLoggedIndex.jsp\" class=\"button\">Homepage</a>\t\r\n");
      ...
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t<td>Il file deve essere di formato .txt e pesare massimo 10\r\n");
      out.write("\t\t\t\t\t\tMB.</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td></td>\r\n");
